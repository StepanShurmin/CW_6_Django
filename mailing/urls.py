...
from mailing.views import index, MailingSettingsListView, ClientListView, MailingMessageListView, ContactsTemplateView, \
...
urlpatterns = [
    ...
    path('settings/', MailingSettingsListView.as_view(), name='mailing_settings_list'),
